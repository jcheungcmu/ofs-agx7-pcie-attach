...
//
`ifndef __HOST_OFS_BFM_MEMORY_CLASS_PKG__
`define __HOST_OFS_BFM_MEMORY_CLASS_PKG__

package host_ofs_bfm_memory_class_pkg; 
...
endpackage: host_ofs_bfm_memory_class_pkg

`endif // __HOST_OFS_BFM_MEMORY_CLASS_PKG__
