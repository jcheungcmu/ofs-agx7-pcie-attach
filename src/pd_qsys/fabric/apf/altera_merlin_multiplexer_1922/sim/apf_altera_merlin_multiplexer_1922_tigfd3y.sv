...
//   output_name:         apf_altera_merlin_multiplexer_1922_tigfd3y
//   NUM_INPUTS:          7
//   ARBITRATION_SHARES:  1 1 1 1 1 1 1
//   ARBITRATION_SCHEME   "no-arb"
//   PIPELINE_ARB:        0
//   PKT_TRANS_LOCK:      96 (arbitration locking enabled)
//   ST_DATA_W:           151
//   ST_CHANNEL_W:        14
// ------------------------------------------

module apf_altera_merlin_multiplexer_1922_tigfd3y
(
    // ----------------------
    // Sinks
    // ----------------------
    ...
    always @* begin
      lock[0] = sink0_data[96];
      lock[1] = sink1_data[96];
      lock[2] = sink2_data[96];
      lock[3] = sink3_data[96];
      lock[4] = sink4_data[96];
      lock[5] = sink5_data[96];
      lock[6] = sink6_data[96];
    end
