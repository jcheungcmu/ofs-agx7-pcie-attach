...
//    output_name             apf_altera_merlin_router_1921_a646sqa
//    pkt_addr_h              91
//    pkt_addr_l              72
//    pkt_dest_id_h           117
//    pkt_dest_id_l           115
...
//    pkt_trans_read          95
//    pkt_trans_write         94
//    slaves_info             5:10:0x40000:0x50000:write:1:0:0:1
//    st_channel_w            14
//    st_data_w               151
// ------------------------------------------

module apf_altera_merlin_router_1921_a646sqa_default_decode
  #(
...
module apf_altera_merlin_router_1921_a646sqa
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    apf_altera_merlin_router_1921_a646sqa_default_decode the_default_decode(
    ...
    always @* begin
        ...
        // slave 0: [0x40000, 0x50000) : sel [19:16]
        if ( {address[19:16],{16 {1'b0}}} == 19'h40000  && write_transaction  ) begin
            src_channel = 14'b10;
