...
module apf_altera_merlin_axi_slave_ni_1971_47p3fxq
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    apf_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1971_spfdq2a #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    apf_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_a42nnri #(
      .SYMBOLS_PER_BEAT (1),
    ...
    apf_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_h6wexfa #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       apf_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_ouwi2vq #(
             .SYMBOLS_PER_BEAT (1),
