...
`timescale 1 ps / 1 ps
module apf_st2mm_slv (
		input  wire        clk,       //                  clock.clk
		input  wire        rst_n,     //                  reset.reset_n
		input  wire [15:0] s_awaddr,  //  altera_axi4lite_slave.awaddr
		...
		input  wire [15:0] s_araddr,  //                       .araddr
		...
		output wire [15:0] m_awaddr,  // altera_axi4lite_master.awaddr
		...
		output wire [15:0] m_araddr,  //                       .araddr
	...
	axi4lite_shim #(
		...
		.s_awaddr  (s_awaddr),  //   input,  width = 16,  altera_axi4lite_slave.awaddr
		...
		.s_araddr  (s_araddr),  //   input,  width = 16,                       .araddr
		...
		.m_awaddr  (m_awaddr),  //  output,  width = 16, altera_axi4lite_master.awaddr
		...
		.m_araddr  (m_araddr),  //  output,  width = 16,                       .araddr
