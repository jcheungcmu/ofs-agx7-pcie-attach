...
module bpf_apf_mst (
		...
		input  wire [17:0] s_awaddr,  //  altera_axi4lite_slave.awaddr
		...
		input  wire [17:0] s_araddr,  //                       .araddr
		...
		output wire [17:0] m_awaddr,  // altera_axi4lite_master.awaddr
		...
		output wire [17:0] m_araddr,  //                       .araddr
	...
	axi4lite_shim #(
		...
		.s_awaddr  (s_awaddr),  //   input,  width = 18,  altera_axi4lite_slave.awaddr
		...
		.s_araddr  (s_araddr),  //   input,  width = 18,                       .araddr
		...
		.m_awaddr  (m_awaddr),  //  output,  width = 18, altera_axi4lite_master.awaddr
		...
		.m_araddr  (m_araddr),  //  output,  width = 18,                       .araddr
