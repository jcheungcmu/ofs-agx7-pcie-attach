...
module bpf_pmci_slv (
		...
		input  wire [16:0] s_awaddr,  //  altera_axi4lite_slave.awaddr
		...
		input  wire [16:0] s_araddr,  //                       .araddr
		...
		output wire [16:0] m_awaddr,  // altera_axi4lite_master.awaddr
		...
		output wire [16:0] m_araddr,  //                       .araddr
	...
	axi4lite_shim #(
		...
		.s_awaddr  (s_awaddr),  //   input,  width = 17,  altera_axi4lite_slave.awaddr
		...
		.s_araddr  (s_araddr),  //   input,  width = 17,                       .araddr
		...
		.m_awaddr  (m_awaddr),  //  output,  width = 17, altera_axi4lite_master.awaddr
		...
		.m_araddr  (m_araddr),  //  output,  width = 17,                       .araddr
