...
module bpf_pmci_mst (
		...
		input  wire [20:0] s_awaddr,  //  altera_axi4lite_slave.awaddr
		...
		input  wire [20:0] s_araddr,  //                       .araddr
		...
		output wire [20:0] m_awaddr,  // altera_axi4lite_master.awaddr
		...
		output wire [20:0] m_araddr,  //                       .araddr
	...
	axi4lite_shim #(
		...
		.s_awaddr  (s_awaddr),  //   input,  width = 21,  altera_axi4lite_slave.awaddr
		...
		.s_araddr  (s_araddr),  //   input,  width = 21,                       .araddr
		...
		.m_awaddr  (m_awaddr),  //  output,  width = 21, altera_axi4lite_master.awaddr
		...
		.m_araddr  (m_araddr),  //  output,  width = 21,                       .araddr
