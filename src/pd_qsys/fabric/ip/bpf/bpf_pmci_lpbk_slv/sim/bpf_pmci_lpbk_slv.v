...
`timescale 1 ps / 1 ps
module bpf_pmci_lpbk_slv (
		input  wire        clk,       //                  clock.clk
		input  wire        rst_n,     //                  reset.reset_n
		input  wire [19:0] s_awaddr,  //  altera_axi4lite_slave.awaddr
		...
		input  wire [19:0] s_araddr,  //                       .araddr
		...
		output wire [19:0] m_awaddr,  // altera_axi4lite_master.awaddr
		...
		output wire [19:0] m_araddr,  //                       .araddr
	...
	axi4lite_shim #(
		...
		.s_awaddr  (s_awaddr),  //   input,  width = 20,  altera_axi4lite_slave.awaddr
		...
		.s_araddr  (s_araddr),  //   input,  width = 20,                       .araddr
		...
		.m_awaddr  (m_awaddr),  //  output,  width = 20, altera_axi4lite_master.awaddr
		...
		.m_araddr  (m_araddr),  //  output,  width = 20,                       .araddr
