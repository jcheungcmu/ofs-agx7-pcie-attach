...
# ----------------------------------------
# If bpf_pcie_slv is one of several IP cores in your
...
TOP_LEVEL_NAME="bpf_pcie_slv.bpf_pcie_slv"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set memory_files [concat $memory_files [bpf_pcie_slv::get_memory_files "$QSYS_SIMDIR"]]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [bpf_pcie_slv::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [bpf_pcie_slv::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [bpf_pcie_slv::get_dpi_libraries "$QSYS_SIMDIR"]]
