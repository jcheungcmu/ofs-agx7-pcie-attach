...
module bpf_altera_merlin_axi_slave_ni_1971_5c3miba
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    bpf_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1971_zewvfuy #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    bpf_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_a42nnri #(
      .SYMBOLS_PER_BEAT (1),
    ...
    bpf_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_h6wexfa #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       bpf_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_7asbqai #(
             .SYMBOLS_PER_BEAT (1),
