...
module bpf_altera_merlin_axi_slave_ni_1971_hfsbxta
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    bpf_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_1971_6f46wua #(
        .SYMBOLS_PER_BEAT    (1),
