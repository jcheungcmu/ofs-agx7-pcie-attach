// bpf_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_a42nnri.v

// Generated using ACDS version 23.4 79

`timescale 1 ps / 1 ps
module bpf_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_1971_a42nnri #(
		...
		input  wire [68:0] in_data,   //          .data
		input  wire        out_ready, //   source0.ready
		output wire        out_valid, //          .valid
		output wire [68:0] out_data   //          .data
	);

	bpf_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_data           (in_data),   //   input,  width = 69,          .data
		.out_ready         (out_ready), //   input,   width = 1,   source0.ready
		.out_valid         (out_valid), //  output,   width = 1,          .valid
		.out_data          (out_data),  //  output,  width = 69,          .data
