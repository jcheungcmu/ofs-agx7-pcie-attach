...
# ACDS 23.4 79 linux 2024.08.28.01:46:21
...
# ----------------------------------------
# If bpf is one of several IP cores in your
...
TOP_LEVEL_NAME="bpf.bpf"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/ofs_install/quartus/23.4/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [bpf::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [bpf::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [bpf::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [bpf::get_design_libraries]]
...
mkdir -p ./libraries/tennm_agilex7_io96_ver/
mkdir -p ./libraries/lpm/
mkdir -p ./libraries/sgate/
mkdir -p ./libraries/altera/
mkdir -p ./libraries/altera_mf/
mkdir -p ./libraries/altera_lnsim/
mkdir -p ./libraries/tennm/
mkdir -p ./libraries/tennm_hssi/
mkdir -p ./libraries/tennm_hssi_e0/
mkdir -p ./libraries/tennm_hssi_p0/
mkdir -p ./libraries/tennm_agilex7_io96/
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set memory_files [concat $memory_files [bpf::get_memory_files "$QSYS_SIMDIR"]]
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$QUARTUS_INSTALL_DIR/eda/sim_lib/synopsys/cr3v0_serdes_models_ncrypt.sv" -work tennm_hssi_e0_ver     
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms.sv"                      -work tennm_hssi_p0_ver     
  vlogan +v2k -sverilog +warn=noDCTL,noTMR $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms_ncrypt.sv"               -work tennm_hssi_p0_ver     
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex7_io96.sv"           -work tennm_agilex7_io96_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex7_io96_ncrypt.sv"    -work tennm_agilex7_io96_ver
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$QUARTUS_INSTALL_DIR/eda/sim_lib/synopsys/tennm_atoms_ncrypt.sv"         -work tennm                 
  vhdlan $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                      "$QUARTUS_INSTALL_DIR/eda/sim_lib/tennm_atoms.vhd"                        -work tennm                 
  vhdlan $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                      "$QUARTUS_INSTALL_DIR/eda/sim_lib/tennm_components.vhd"                   -work tennm                 
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$QUARTUS_INSTALL_DIR/eda/sim_lib/tennm_hssi_atoms_ncrypt.sv"             -work tennm_hssi            
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$QUARTUS_INSTALL_DIR/eda/sim_lib/synopsys/cr3v0_serdes_models_ncrypt.sv" -work tennm_hssi_e0         
  vhdlan $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                      "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_components.vhd"                -work tennm_hssi_p0         
  vhdlan $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                      "$QUARTUS_INSTALL_DIR/eda/sim_lib/ctp_hssi_atoms.vhd"                     -work tennm_hssi_p0         
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex7_io96.sv"           -work tennm_agilex7_io96    
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                    "$QUARTUS_INSTALL_DIR/../devices/sim_lib/tennm_agilex7_io96_ncrypt.sv"    -work tennm_agilex7_io96    
fi
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [bpf::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [bpf::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [bpf::get_dpi_libraries "$QSYS_SIMDIR"]]
