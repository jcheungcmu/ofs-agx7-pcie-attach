...
//    output_name             bpf_altera_merlin_router_1921_c2ajpdi
//    pkt_addr_h              92
//    pkt_addr_l              72
//    pkt_dest_id_h           120
//    pkt_dest_id_l           117
...
//    pkt_trans_read          96
//    pkt_trans_write         95
//    slaves_info             0:10:0x0:0x100000:write:1:0:0:1
//    st_channel_w            20
//    st_data_w               154
// ------------------------------------------

module bpf_altera_merlin_router_1921_c2ajpdi_default_decode
  #(
...
module bpf_altera_merlin_router_1921_c2ajpdi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    bpf_altera_merlin_router_1921_c2ajpdi_default_decode the_default_decode(
    ...
    always @* begin
        ...
        if ( {address[20:20],{20 {1'b0}}} == 20'h0  && write_transaction  ) begin
            src_channel = 20'b10;
